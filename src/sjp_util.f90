...
SUBROUTINE READ_SCATTER_FILE (FILENAME, QMIN, Q, I, NO)
    ...
    REAL, INTENT(IN) :: QMIN
    REAL, DIMENSION(*), INTENT(INOUT) :: Q , I
...
SUBROUTINE QRANGE_MATCH(QOBS, QCALC, ICALC, XNO, CNO, IMATCH, MNO)
	...
	REAL, DIMENSION(*), INTENT(IN) :: QOBS, QCALC, ICALC	
	INTEGER, INTENT(IN) :: XNO, CNO
	REAL, DIMENSION(*), INTENT(OUT) :: IMATCH
	INTEGER, INTENT(OUT) :: MNO
		
	INTEGER :: I, J
	REAL :: QMINDIFF, DELTAQ
...
REAL FUNCTION AVERAGE_DATA (DATAIN, N)
...
REAL FUNCTION CALC_RFACTOR (QOBS, IOBS, IMATCH, N, QMIN, QMAX, CON, VERBOSE)
	
	! Calculate the R factor comparing IOBS to IMATCH
	
	REAL, DIMENSION(*), INTENT(IN) :: QOBS, IOBS, IMATCH
	INTEGER, INTENT(IN) :: N
	REAL, INTENT(IN) :: QMIN, QMAX
	REAL, INTENT(INOUT) :: CON
	LOGICAL, INTENT(IN) :: VERBOSE
		
	REAL :: DELTAC, ORFAC, RFNUM, RFDEN, RFACTOR
	INTEGER :: NDX
